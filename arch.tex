...
\section*{Partition Scheme}
    ...
    \noindent Adding a discrete home partition offers a few notable advantages;
    This can allow you to change distributions or reinstall while keeping your
    home folder intact as well as let you share you home folder among multiple
    installations. On more modern systems, the swap partition is less critical,
    being used for data overflow from RAM. Inclusion of a swap partition is
    left to the discretion of the reader. Typical sizes for each type of
    partition can be seen in Figure \ref{part_sizes}.
